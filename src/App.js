...
function App() {
  const VehiclesList = [
    ...
    { id: 4, name: "", item: "item2", lastPlaceId: 0 },
    { id: 5, name: "", item: "item3", lastPlaceId: 0 },
    { id: 8, name: "", item: "item4", lastPlaceId: 0 },
    { id: 10, name: "", item: "item5", lastPlaceId: 0 },
    { id: 11, name: "", item: "item6", lastPlaceId: 0 },
    { id: 12, name: "", item: "item7", lastPlaceId: 0 },
    { id: 13, name: "", item: "item8", lastPlaceId: 0 },
    { id: 15, name: "", item: "item9", lastPlaceId: 0 },
    { id: 20, name: "", item: "item10", lastPlaceId: 0 },
    { id: 22, name: "", item: "item11", lastPlaceId: 0 },
    { id: 25, name: "", item: "item12", lastPlaceId: 0 },

    { id: 30, name: "", item: "item13", lastPlaceId: 0 },
    { id: 40, name: "", item: "item14", lastPlaceId: 0 },
    { id: 44, name: "", item: "item15", lastPlaceId: 0 },
    { id: 49, name: "", item: "item16", lastPlaceId: 0 },
    { id: 50, name: "", item: "item17", lastPlaceId: 0 },
    { id: 51, name: "", item: "item18", lastPlaceId: 0 },
    { id: 53, name: "", item: "item19", lastPlaceId: 0 },
    { id: 58, name: "", item: "item20", lastPlaceId: 0 },
    { id: 62, name: "", item: "item21", lastPlaceId: 0 },
    { id: 76, name: "", item: "item22", lastPlaceId: 0 },
    { id: 84, name: "", item: "item23", lastPlaceId: 0 },

    { id: 87, name: "", item: "item24", lastPlaceId: 0 },
    { id: 90, name: "", item: "item25", lastPlaceId: 0 },
    { id: 95, name: "", item: "item26", lastPlaceId: 0 },
    // ... (otros vehículos)
  ];
  ...
  const PlacesList = [
    ...
    { id: 7, name: 'CRUCE CASCABELA 6', vehicles: [] },
    { id: 8, name: 'SANTA MARTA', vehicles: [] },    
    { id: 9, name: 'BAMQUILLA', vehicles: [] },
    { id: 10, name: 'BASE 6', vehicles: [] },
